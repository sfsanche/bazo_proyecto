...
int main(int argc, char ** argv)
{
  ...
  while ( ! gSigTERM ) 
  {
	...
	break;
	 ...
	 //TWEAK TO ACCEPT ONLY EVENTS WITH TWO CHARGED LEPTONS IN THE FINAL STATE
	...
	delete p;	
	 ...
	 if (cleptons == 2)
	 {
		LOG("myAnalysis", pNOTICE) "Event: "<< ievent << " shreds!\n";
	 }
	else			//Skip events that don't have exactly two fs leptons
	{
		delete event;
