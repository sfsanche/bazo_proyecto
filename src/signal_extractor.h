...
// Wed Jun 29 17:07:32 2016 by ROOT version 5.34/18
// from TTree gst/GENIE Summary Event Tree
// found on file: ../lair/gntp.NuMI_C12_Dilepton_inclusive.gst.root
//////////////////////////////////////////////////////////
...
class signal_extractor : public TSelector {
public :
   ...
   //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	TLorentzVector pl1, pl2;	//Leptons 4-momenta
	int found_a_lepton;			//Already found a lepton flag
	
	//New branches, for MVA analysis
	int 		nmuons;			//Number of muons in event
	TBranch		*b_nmuons;
	
	Double_t Wlep;				//Leptonic invariant mass
	TBranch		*b_Wlep;


   //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

   signal_extractor(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~signal_extractor() { }
   ...
   ClassDef(signal_extractor,0);
};

#endif

#ifdef signal_extractor_cxx
void signal_extractor::Init(TTree *tree)
{
   ...
   //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	b_nmuons = fChain->Branch("nmuons",&nmuons,"nmuons/I");
	b_Wlep   = fChain->Branch("Wlep",&Wlep,"Wlep/F");

   //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

}

Bool_t signal_extractor::Notify()
{
...
#endif // #ifdef signal_extractor_cxx
