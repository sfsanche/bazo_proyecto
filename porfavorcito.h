...
// Fri Jun 24 18:14:42 2016 by ROOT version 5.34/32
// from TTree gst/GENIE Summary Event Tree
// found on file: gntp.NumiFlux_C12.gst
//////////////////////////////////////////////////////////

#ifndef porfavorcito_h
#define porfavorcito_h
...
class porfavorcito : public TSelector {
public :
...
TCanvas Canvas;
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
   porfavorcito(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~porfavorcito() { }
   ...
   ClassDef(porfavorcito,0);
  
};

#endif

#ifdef porfavorcito_cxx
void porfavorcito::Init(TTree *tree)
{
